...
public class Villa extends Facility {
 ...
 private int soTang;
    ...
    public Villa(String tenDichVu, double dienTichSuDung, int chiPhiThue, int soLuongNguoiToiDa, Date kieuThue, String tieuChuanPhong, int dienTichHoBoi, int soTang) {
